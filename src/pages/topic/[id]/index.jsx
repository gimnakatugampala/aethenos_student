...
import {
  ...
  GetAllCoursesByTopicName,
  GetBeginnerCoursesByTopicName,
  ...
  GetMostPopularCoursesByTopicName,
  GetNewCoursesByTopicName,
  GetSubCategoriesByCategoryLinkName,
  GetTopCoursesByTopicName,
  GetTopicNameByLinkName,
  ...
  useEffect(() => {
    if (id != null) {
      ...
      GetTopCoursesByTopicName(
        ...
        settop_course_sub_cat_Name,
        settop_course_sub_cat_link,
        setloading_top_courses
      );
      GetNewCoursesByTopicName(id, setnew_courses, setloading_new_courses);
      GetBeginnerCoursesByTopicName(
        id,
        setbeginners_favs,
        setloading_beginner_favs
      );
      GetMostPopularCoursesByTopicName(
        id,
      ...
      GetTopicNameByLinkName(
        ...
        setCategoryLinkName,
        setSubCategoryName,
        setSubCategoryLinkName,
        setloading_top_title
      );
      console.log(id);
    }
        ...
        <div className="mx-2 mx-sm-3 mx-md-4 mx-lg-5">
          <div className="row mx-2 mx-sm-3 mx-md-4 mx-lg-5">
            {loading_top_title ? (
              ...
              <div className="mb-4">
                ...
                <h5 className="m-0 p-0">
                  {TopicName} relates to{" "}
                  <a
                    className="text-danger"
                    href={`/courses/${CategoryLinkName}`}
                  >
                    <b>{CategoryName}</b>
                  </a>
                  ,{" "}
                  <a
                    className="text-danger"
                    href={`/courses/${CategoryLinkName}/${SubCategoryLinkName}`}
                  >
                    <b>{SubCategoryName}</b>
                  </a>
                </h5>
                      ...
                      {loading_most_popular_courses ? (
                        ...
                        <div className="row g-3 mb-5">
                          ...
                          most_popular_courses != null ? (
                            ...
                            <h4 className="mt-5">No Most Popular Courses Available</h4>
                          )}
                        </div>
                      )}
                  ...
                  <div className="course-tab-content">
                    <div className="course-overview">
                      {loading_new_courses ? (
                        ...
                        <div className="row g-3 mb-5">
                          {new_courses.length > 0 && new_courses != null ? (
                            ...
                            <h4 className="mt-5" >No New Courses Available</h4>
                          )}
                        </div>
                      )}
                  ...
                  <div className="course-tab-content">
                    <div className="course-overview">
                      {loading_beginner_favs ? (
                        ...
                        <div className="row g-3 mb-5">
                          {beginners_favs.length > 0 &&
                          beginners_favs != null ? (
                            beginners_favs.slice(0, next)?.map((course) => {
                              return (
                                <div
                                  key={course.id}
                                  className="col-md-6 col-xl-3"
                            ...
                            <h4 className="mt-5" >No Beginner Favorites Courses Available</h4>
                          )}
                        </div>
                      )}
            ...
            <div className="col-lg-12 mb-5">
              <h4 className="p-2">
                Top courses in {TopicName} and{" "}
                <a
                  className="text-danger text-decoration-underline"
                  href={`/courses/${CategoryLinkName}/${top_course_sub_cat_link}`}
                >
                  {top_course_sub_cat_Name}
                </a>
              </h4>
              ...
              {loading_top_courses ? (
                ...
                <div className="row g-3 mb-5">
                  {top_course_courses != null &&
                  top_course_courses.length > 0 ? (
                    top_course_courses.slice(0, next)?.map((course) => {
                      return (
