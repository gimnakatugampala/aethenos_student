...
import {
  GetAllCoursesBySubCategory,
  GetCourseCategoryTitle,
  GetCourseSubCategoryTitle,
  GetCoursesBySubCategoryInstructor,
  GetCoursesBySubCategoryMostPopular,
  GetCoursesBySubCategoryNew,
  GetCoursesBySubCategoryTopics,
  GetCoursesBySubCategoryTrending,
...
const GetCoursesBySubCategory = ({ CatName, SubCatName }) => {
  ...
  useEffect(() => {
    if (code != null && id != null) {
      ...
      GetCoursesBySubCategoryTopics(
        code,
        setloading_topics_list,
        setpopular_topics
      );
      GetAllCoursesBySubCategory(
        code,
        setallcourses,
        setloading_all_courses_list
      );
    }
  }, [code]);
                      ...
                      {loading_trending_courses ? (
                        ...
                        <div className="row g-3 mb-5">
                          ...
                          trending_courses != null ? (
                            ...
                            <h4 className="mt-5">No Trending Courses Available</h4>
                          )}
                        </div>
                      )}
              ...
              {loading_topics_list ? (
                ...
                >
                  {popular_topics != null || popular_topics.length > 0 ? (
                    ...
                    <h4 className="mt-5" >No Topics Available</h4>
                  )}
                </Carousel>
              )}
            </div>
              ...
              {loading_instructors_list ? (
                ...
                >
                  {instructors != null && instructors.length > 0 ? (
                    ...
                    <h4 className="mt-5" >No Instructors Found</h4>
                  )}
                </Carousel>
              )}
            </div>
