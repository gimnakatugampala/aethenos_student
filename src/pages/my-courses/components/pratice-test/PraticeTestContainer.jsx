          ...
          <React.Fragment>
            {PraticeTestactiveStep === 0 && (
              <div className='my-3'>
                ...
                {selectedPracticeTest.getPracticeTests && selectedPracticeTest.getPracticeTests[0] && (
                  <>
                    ...
                    {selectedPracticeTest.getPracticeTests[0].instructions && (
                      <>
                    ...
                    {selectedPracticeTest.getPracticeTests[0].externalLink && (
                      <a target='_blank' href={selectedPracticeTest.getPracticeTests[0].externalLink}>
                        {selectedPracticeTest.getPracticeTests[0].externalLink} <i className="fas fa-external-link-alt"></i>
                      </a>
                    )}
                  </>
                )}
            ...
            {PraticeTestactiveStep === 1 && (
              <div className="my-3">
                ...
                {selectedPracticeTest.getPracticeTests && selectedPracticeTest.getPracticeTests[0] && (
                  <>
                    <a className='btn btn-danger my-2' href={`${IMG_HOST}${selectedPracticeTest.getPracticeTests[0].practiceTestQuestionSheet}`} download>
                      Download Questions <i className="fas fa-download"></i>
                    </a>
                    <br />
                    {selectedPracticeTest.getPracticeTests[0].questionLink && (
                      <a target='_blank' href={selectedPracticeTest.getPracticeTests[0].questionLink}>
                        {selectedPracticeTest.getPracticeTests[0].questionLink} <i className="fas fa-external-link-alt"></i>
                      </a>
                    )}
                  </>
                )}
            ...
            {PraticeTestactiveStep === 2 && (
              <div className='my-3'>
                ...
                {selectedPracticeTest.getPracticeTests && selectedPracticeTest.getPracticeTests[0] && (
                  <>
                    <a className='btn btn-danger my-2' href={`${IMG_HOST}${selectedPracticeTest.getPracticeTests[0].practiceTestSolutionSheet}`} download>
                      Download Solutions <i className="fas fa-download"></i>
                    </a>
                    <br />
                    {selectedPracticeTest.getPracticeTests[0].solutionLink && (
                      <a target='_blank' href={selectedPracticeTest.getPracticeTests[0].solutionLink}>
                        {selectedPracticeTest.getPracticeTests[0].solutionLink} <i className="fas fa-external-link-alt"></i>
                      </a>
                    )}
                  </>
                )}
            ...
            {PraticeTestactiveStep === steps.length - 1 ? (
              ...
              <Box sx={{ display: 'flex', flexDirection: 'row', pt: 2 }}>
                ...
                <Button onClick={handleNext}>
                  {PraticeTestactiveStep === steps.length - 1 ? 'Finish' : 'Next'}
                </Button>
              </Box>
            )}
          </React.Fragment>
